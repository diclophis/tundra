...
(function() {
    ...
    var chromeVersion = !!navigator.mozGetUserMedia ? 0 : parseInt(navigator.userAgent.match( /WebKit\/([0-9]+)\./ )[1]);
    ...
    function setDefaults(connection) {
        ...
        if (isChrome && chromeVersion >= 28 && !isMobileDevice) {
            connection.bandwidth.audio = 80; // 80kbs
            connection.bandwidth.video = 256; // 256kbs
        }
